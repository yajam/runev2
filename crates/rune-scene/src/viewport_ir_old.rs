...
/// Debug toggles so we can enable/disable groups incrementally
/// while debugging unified rendering behavior.
const DEBUG_RENDER_TEXTS: bool = false;
const DEBUG_RENDER_CHECKBOXES: bool = false;
const DEBUG_RENDER_BUTTONS: bool = false;
const DEBUG_RENDER_RADIOS: bool = false;
const DEBUG_RENDER_INPUTS: bool = false;
const DEBUG_RENDER_TEXT_AREAS: bool = false;
const DEBUG_RENDER_SELECTS: bool = false;
const DEBUG_RENDER_LABELS: bool = false;
const DEBUG_RENDER_IMAGES: bool = false;
const DEBUG_RENDER_MULTILINE_TEXT: bool = false;
...
impl SampleUIElements {
    ...
    pub fn render(
        ...
        let multiline_height = if DEBUG_RENDER_MULTILINE_TEXT {
