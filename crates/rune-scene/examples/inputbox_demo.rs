...
fn main() -> anyhow::Result<()> {
    ...
    input_box.move_cursor_to_end();
    println!("After moving to end, scroll offset: {}", input_box.scroll_offset());
    
    input_box.move_cursor_to_start();
    println!("After moving to start, scroll offset: {}", input_box.scroll_offset());
    ...
    for i in 0..10 {
        ...
        println!("  Frame {}: cursor visible = {}", i, input_box.is_cursor_visible());
    }
