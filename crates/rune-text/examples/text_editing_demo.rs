...
fn main() {
    ...
    println!("   After insert: '{}' (cursor at {})", layout.text(), cursor);
    println!();
    ...
    println!("   After newline: '{}' (cursor at {})", layout.text().replace('\n', "\\n"), cursor);
    ...
    let cursor = layout.replace_selection(&selection, "Rust", &font, font_size, None, WrapMode::NoWrap);
    println!("   After replacing 'World' with 'Rust': '{}' (cursor at {})", layout.text(), cursor);
    println!();
    ...
    println!("   After backspace: '{}' (cursor at {})", layout.text(), cursor);
    println!();
    ...
    println!("   After delete: '{}' (cursor at {})", layout.text(), cursor);
    println!();
    ...
    println!("   After delete word backward: '{}' (cursor at {})", layout.text(), cursor);
    println!();
    ...
    println!("   After deleting selection: '{}' (cursor at {})", layout.text(), cursor);
    println!();
    ...
    println!("   After deleting line 2: '{}' (cursor at {})", layout.text().replace('\n', "\\n"), cursor);
    println!();
    ...
    println!("   After inserting emoji: '{}' (cursor at {})", layout.text(), cursor);
    
    let cursor = layout.delete_backward(cursor, &font, font_size, None, WrapMode::NoWrap);
    println!("   After deleting one emoji: '{}' (cursor at {})", layout.text(), cursor);
    println!();

    // 11. Text wrapping with insertion
    println!("11. Text Wrapping:");
    let mut layout = TextLayout::new("Short", &font, font_size);
    println!("   Initial: '{}' ({} line)", layout.text(), layout.lines().len());
    
    layout.insert_str(5, " text that should wrap to multiple lines", &font, font_size, Some(150.0), WrapMode::BreakWord);
    println!("   After insert with wrapping: '{}' ({} lines)", layout.text(), layout.lines().len());
    println!();
