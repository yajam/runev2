...
impl Default for LinearBgScene {
    fn default() -> Self {
        Self
    }
}
...
impl Scene for LinearBgScene {
    ...
    fn paint_root_background(
        ...
        let stops_linear = vec![
            (
                0.0,
                engine_core::ColorLinPremul::from_srgba_u8([0xff, 0x6b, 0x6b, 0xff]),
            ),
            (
                0.25,
                engine_core::ColorLinPremul::from_srgba_u8([0xff, 0xd9, 0x3d, 0xff]),
            ),
            (
                0.5,
                engine_core::ColorLinPremul::from_srgba_u8([0x6b, 0xcf, 0x63, 0xff]),
            ),
            (
                0.75,
                engine_core::ColorLinPremul::from_srgba_u8([0x4d, 0x96, 0xff, 0xff]),
            ),
            (
                1.0,
                engine_core::ColorLinPremul::from_srgba_u8([0xc7, 0x7d, 0xff, 0xff]),
            ),
        ];
