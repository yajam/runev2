...
impl UiElementsScene {
    fn build(&self) -> DisplayList {
        ...
        p.text(
            engine_core::TextRun {
                text: "UI Elements".to_string(),
                pos: [col1_x, y],
                size: 24.0,
                color: Color::from_srgba_u8([235, 240, 255, 255]),
            },
            2,
        );
        y += 36.0;
        ...
        p.text(
            engine_core::TextRun {
                ...
                pos: [col1_x + 12.0, y + 24.0],
                size: 16.0,
                color: Color::from_srgba_u8([255, 255, 255, 255]),
            },
            4,
        );
        let btn2_r = RoundedRect {
            rect: Rect {
                x: col1_x + 176.0,
                y,
                w: 180.0,
        ...
        p.rounded_rect(
            btn2_r,
            Brush::Solid(Color::from_srgba_u8([99, 104, 118, 255])),
            3,
        );
        p.text(
            engine_core::TextRun {
                text: "Secondary".to_string(),
                pos: [col1_x + 188.0, y + 24.0],
                size: 16.0,
                color: Color::from_srgba_u8([255, 255, 255, 255]),
            },
            4,
        ...
        p.rect(
            cb0,
            Brush::Solid(Color::from_srgba_u8([240, 240, 240, 255])),
            3,
        );
        p.rect(
            Rect {
        ...
        p.text(
            engine_core::TextRun {
                ...
                pos: [col1_x + 28.0, y + 16.0],
                size: 16.0,
                color: Color::from_srgba_u8([240, 240, 240, 255]),
            },
            4,
        );
        ...
        p.text(
            engine_core::TextRun {
                text: "Checked + Focus".to_string(),
                pos: [col1_x + 188.0, y + 16.0],
                size: 16.0,
                color: Color::from_srgba_u8([240, 240, 240, 255]),
            },
            4,
        ...
        p.ellipse(
            r1c,
            [5.0, 5.0],
            Brush::Solid(Color::from_srgba_u8([40, 120, 220, 255])),
            5,
        );
        p.text(
            engine_core::TextRun {
                text: "Option B (focus)".to_string(),
                pos: [col1_x + 168.0, y + 16.0],
                size: 16.0,
                color: Color::from_srgba_u8([240, 240, 240, 255]),
            },
            4,
        ...
        p.rect(
            ib,
            Brush::Solid(Color::from_srgba_u8([255, 255, 255, 255])),
            3,
        );
        p.stroke_rect(
            ib,
            Stroke { width: 1.0 },
            Brush::Solid(Color::from_srgba_u8([200, 200, 200, 255])),
            4,
        );
        p.text(
            engine_core::TextRun {
                text: "Type here...".to_string(),
                pos: [ib.x + 10.0, y + 22.0],
                size: 16.0,
                color: Color::from_srgba_u8([16, 16, 16, 255]),
            },
            5,
        );
        y += 44.0;
        ...
        p.text(
            engine_core::TextRun {
                text: "Multi-line text area".to_string(),
                pos: [ta.x + 8.0, y + 20.0],
                size: 15.0,
                color: Color::from_srgba_u8([16, 16, 16, 255]),
            },
        ...
        p.text(
            engine_core::TextRun {
                text: "Line two wraps or clips".to_string(),
                pos: [ta.x + 8.0, y + 40.0],
                size: 15.0,
                color: Color::from_srgba_u8([16, 16, 16, 255]),
            },
        ...
        p.text(
            engine_core::TextRun {
                text: "Select option".to_string(),
                pos: [sel1.x + 10.0, y + 22.0],
                size: 16.0,
                color: Color::from_srgba_u8([16, 16, 16, 255]),
            },
            5,
        ...
        let mut tri = Path {
            cmds: Vec::new(),
            fill_rule: engine_core::FillRule::NonZero,
        };
        let ax = sel1.x + sel1.w - 14.0;
        let ay = y + sel1.h * 0.5;
        ...
        p.text(
            engine_core::TextRun {
                text: "Open + Focused".to_string(),
                pos: [sel2.x + 10.0, y + 22.0],
                size: 16.0,
                color: Color::from_srgba_u8([16, 16, 16, 255]),
            },
            5,
        ...
        let ax2 = sel2.x + sel2.w - 14.0;
        let ay2 = y + sel2.h * 0.5;
        ...
        p.text(
            engine_core::TextRun {
                ...
                pos: [col2_x, 40.0],
                size: 20.0,
                color: Color::from_srgba_u8([220, 230, 250, 255]),
            },
            2,
        );
        p.text(
            engine_core::TextRun {
                text: "Label element".to_string(),
                pos: [col2_x, 40.0 + 36.0],
                size: 16.0,
                color: Color::from_srgba_u8([230, 230, 235, 255]),
            },
            3,
        );
        p.text(
            engine_core::TextRun {
                text: "Plain Text element".to_string(),
                pos: [col2_x, 40.0 + 36.0 + 28.0],
                size: 16.0,
                color: Color::from_srgba_u8([210, 245, 210, 255]),
            },
            3,
        );
        ...
        let img = Rect {
            x: col2_x,
            y: 40.0 + 36.0 + 28.0 + 40.0,
            w: 180.0,
            h: 120.0,
        };
        p.rect(
            img,
            Brush::Solid(Color::from_srgba_u8([80, 160, 220, 255])),
            3,
        );
        p.text(
            engine_core::TextRun {
                text: "Image placeholder".to_string(),
                pos: [img.x, img.y + img.h + 20.0],
                size: 14.0,
                color: Color::from_srgba_u8([235, 240, 255, 200]),
            },
            4,
        );
