...
impl Default for RadialBgScene {
    fn default() -> Self {
        Self
    }
}
...
impl Scene for RadialBgScene {
    ...
    fn paint_root_background(
        ...
        let stops_circle = vec![
            (
                0.0,
                engine_core::ColorLinPremul::from_srgba_u8([0x3b, 0x82, 0xf6, 0xff]),
            ),
            (
                0.5,
                engine_core::ColorLinPremul::from_srgba_u8([0x1e, 0x3a, 0x8a, 0xff]),
            ),
            (
                0.75,
                engine_core::ColorLinPremul::from_srgba_u8([0x10, 0xb9, 0x81, 0xff]),
            ),
            (
                1.0,
                engine_core::ColorLinPremul::from_srgba_u8([0x10, 0xb9, 0x81, 0xff]),
